...
public enum SafeHouse implements Serializable {
    ...
    England("\n You arrived at the Westminster Abbey, a gothic styled church of the 13th"
            ...
            + "\n remember that the Abbey is a burial place of kings, statesmen, poets, scientists,"
    ...
    France("\n It’s easy to find because of its white"
    ...
    Canada("\n The city has many tall buildings but the"
